export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'anvatngonre',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Anvatngonre',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'anvatngonre.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://anvatngonre.com',
